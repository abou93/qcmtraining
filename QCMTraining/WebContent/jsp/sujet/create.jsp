...
<div class="entry"><form:form commandName="sujetForm"
	action="validationCreate.do" method="post">
...
value="Ajouter une question" /></td>
		...
		<tr>
			<td colspan="2" style="text-align: right;"><input type="submit"
				...
				onclick="window.location.href='<c:url value="/sujet/list.do" />';" />
			</td>
		</tr>
	</table>
</form:form></div>
...
<!-- end contentn -->
<div id="sidebar">
<div id="login"><jsp:include page="/login.do" /></div>
...
<hr />
<div id="footer"><jsp:include page="/jsp/template/footer.jsp" />
</div>
</body>
</html>